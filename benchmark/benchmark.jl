...
# 0.9 seconds (723 allocations: 1.205 GB, 18.70% gc time)
...
# 3.5 seconds (1.01 k allocations: 1.188 GB, 9.56% gc time)
...
# 2.45 seconds (20.00 M allocations: 1.018 GB, 9.60% gc time)
